...
install_python_packages() {
    ...
    pip install streamlit==1.33.0 PyPDF2 chromadb faiss-cpu langchain python-dotenv google-generativeai langchain-community langchain_google_genai==1.0.3 python-docx
    "
}
